...
import { REFRESH_REQUEST_EVENT } from '../core/freshness.js';
import {
  VIEW_CHANGE_EVENT,
  type PartitionRead,
...
import { NO_SELECTION, partitionKey } from '../core/selection.js';
import type { CategorySelection } from '../types.js';
import { LIFTS, NO_ENTRIES, typeLift, type LiftEntries } from '../core/standards.js';
